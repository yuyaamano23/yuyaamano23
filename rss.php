...
$zenn =  simplexml_load_string(file_get_contents('https://zenn.dev/yuyaamano23/feed'));
...
$qiita = simplexml_load_string(file_get_contents('https://qiita.com/Yuya2218/feed.atom'));
